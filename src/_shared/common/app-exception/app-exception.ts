...
export class AppException {
  ...
  static FORBIDDEN = (message, messages?) => {
    return new AppException(HttpStatus.FORBIDDEN, message, messages);
  };
  ...
  static INVALID_TOKEN() {
    return new AppException(HttpStatus.UNAUTHORIZED, 'Session expired');
  }
